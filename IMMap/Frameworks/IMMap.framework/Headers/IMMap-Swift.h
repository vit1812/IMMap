...
#ifndef IMMAP_SWIFT_H
#define IMMAP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IMMap",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5IMMap14DataManagement")
@interface DataManagement : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) DataManagement * _Nonnull shared;)
+ (DataManagement * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (void)setLanguageCode:(NSString * _Nullable)code;
- (void)setLengthUnit:(NSString * _Nonnull)unit;
...
SWIFT_CLASS("_TtC5IMMap29IMFlightNetworkViewController")
@interface IMFlightNetworkViewController : UIViewController
+ (IMFlightNetworkViewController * _Nullable)flightNetworkViewController SWIFT_WARN_UNUSED_RESULT;
- (void)viewDidLoad;
...
@interface IMFlightNetworkViewController (SWIFT_EXTENSION(IMMap)) <UITextFieldDelegate>
...
@interface IMFlightNetworkViewController (SWIFT_EXTENSION(IMMap)) <MKMapViewDelegate>
...
SWIFT_CLASS("_TtC5IMMap19IMMapViewController")
...
SWIFT_PROTOCOL("_TtP5IMMap27IMMapViewControllerDelegate_")
@protocol IMMapViewControllerDelegate <NSObject>
- (void)imMapViewControllerWillClose:(IMMapViewController * _Nonnull)imMapViewController;
- (void)imMapViewController:(IMMapViewController * _Nonnull)imMapViewController willShare:(NSString * _Nonnull)link;
@end
