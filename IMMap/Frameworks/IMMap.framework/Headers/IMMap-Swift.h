...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) DataManagement * _Nonnull sharedInstance;)
+ (DataManagement * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (void)setCurrentLanguageCode:(NSString * _Nullable)code;
...
@interface MKMapView (SWIFT_EXTENSION(IMMap))
- (void)layoutSubviews;
@end
...
@interface MapViewController (SWIFT_EXTENSION(IMMap)) <UITabBarControllerDelegate>
...
@interface MapViewController (SWIFT_EXTENSION(IMMap)) <MKMapViewDelegate>
...
@interface MapViewController (SWIFT_EXTENSION(IMMap)) <UITextFieldDelegate>
...
SWIFT_PROTOCOL("_TtP5IMMap25MapViewControllerDelegate_")
